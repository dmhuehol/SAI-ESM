...
saveName = 'pdf_kde_SST_cntrlfdbck_Leeuwin_10yr_NOMEANTEST'
plotStyle = 'kde' #'kde'
dpiVal = 400

levOfInt = 500 #hPa
latOfInt = np.array([-35,-22])
lonOfInt = np.array([108,115])
# latOfInt = -28.6
# lonOfInt = 112
quantileForFig = 0.66
...
cntrlIntToPlot = [2020,2030,2040,2050,2090]#[2020,2030,2040,2050,2090]#[2020,2050]
fdbckIntToPlot = [2020,2030,2040,2050,2090]#[2020,2030,2040,2050,2090]#[2020,2050]
