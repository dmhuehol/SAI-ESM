...
#   IN_TOKEN
#   OUT_PATH
# For the data associated with the Hueholt et al. "Climate speeds help
# frame..." work, this code was used to process many of the CESM
# experiments. The CDO line alone was used manually (and sometimes broken
# up where chaining was impossible) to process the remaining datasets.
